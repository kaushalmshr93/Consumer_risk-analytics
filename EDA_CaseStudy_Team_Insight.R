...
setwd(file.path("C:/", "EdaCaseStudy"))  
...
zipF<- "C:/EdaCaseStudy/loan.zip"
outDir<-"C:/EdaCaseStudy"
...
#library(DescTools)
#library(dplyr)
requiredPackages = c('lubridate','tidyverse','ggplot2','stringr','grid','gridExtra','DescTools','dplyr','curl')
